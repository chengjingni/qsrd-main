...
public class MD5Utils {
    ...
    public static boolean valid(String text, String md5) {
        return md5.equals(text) || md5.equals(text.toUpperCase());
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(valid(plainText, MD5Upper(plainText)));
        System.out.println(valid(plainText, MD5Lower(plainText)));
        System.out.println(valid(plainText, "21232f297a57a5a743894a0e4a801fc3"));
