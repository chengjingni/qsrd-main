package com.vdata.cloud.auth.common.util.jwt;

import com.vdata.cloud.auth.common.constatns.CommonConstants;
import com.vdata.cloud.auth.common.util.StringHelper;
...
public class JWTHelper {
    ...
    public static String generateToken(IJWTInfo jwtInfo, String priKeyPath, int expire) throws Exception {
        String compactJws = Jwts.builder()
                ...
                .setExpiration(localDateTime2Date(LocalDateTime.now().plusSeconds(expire)))
